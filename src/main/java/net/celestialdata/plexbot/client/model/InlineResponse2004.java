...
public class InlineResponse2004 {
    ...
    private MovieExtendedRecord data;
    @SerializedName(SERIALIZED_NAME_STATUS)
    private String status;

    public InlineResponse2004 data(MovieExtendedRecord data) {
    ...
    public MovieExtendedRecord getData() {
        return data;
    }

    public void setData(MovieExtendedRecord data) {
        this.data = data;
    }
