 ...
 */
@ApiModel(description = "An unrestricted link on Real-Debrid")
@javax.annotation.
...
public class RdbUnrestrictedLink {
    ...
    private StreamableEnum streamable;
    @SerializedName(SERIALIZED_NAME_MIME_TYPE)
    private String mimeType;
    @SerializedName(SERIALIZED_NAME_ALTERNATIVE)
    private Set<RbdUnrestrictedAlternativeLink> alternative = null;
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Size of the file in bytes (0 if unknown)")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Original link")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Hostname of the original server")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Maximum number of chunks allowed")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Disable or enable CRC checking")
    ...
    @SuppressWarnings("unused")
    public RdbUnrestrictedLink download(URI download) {
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Generated download link")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Is the file streamable")
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Type of the file based off its extension")
    ...
    @SuppressWarnings("unused")
    public RdbUnrestrictedLink
    alternative(Set<RbdUnrestrictedAlternativeLink> alternative) {
    ...
    @SuppressWarnings("unused")
    public RdbUnrestrictedLink
    addAlternativeItem(RbdUnrestrictedAlternativeLink alternativeItem) {
        if (this.alternative == null) {
            this.alternative = new LinkedHashSet<>();
        }
    ...
    public Set<RbdUnrestrictedAlternativeLink> getAlternative() {
        return alternative;
    }

    @SuppressWarnings("unused")
    public void setAlternative(Set<RbdUnrestrictedAlternativeLink> alternative) {
        this.alternative = alternative;
    }
    ...
    @SuppressWarnings("unused")
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Type of the file, generally its quality")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, filename, filesize, link, host, chunks, crc,
                download, streamable, mimeType, alternative, type);
    }
    ...
    public String toString() {
        ...
        sb.append("    streamable: ")
                .append(toIndentedString(streamable))
                .append("\n");
        sb.append("    mimeType: ").append(toIndentedString(mimeType)).append("\n");
        sb.append("    alternative: ")
                .append(toIndentedString(alternative))
                .append("\n");
    ...
    public enum CrcEnum {
        ...
        public static CrcEnum fromValue(Integer value) {
        ...
        public static class Adapter extends TypeAdapter<CrcEnum> {
            @Override
            public void write(final JsonWriter jsonWriter, final CrcEnum enumeration)
                    throws IOException {
            ...
            public CrcEnum read(final JsonReader jsonReader) throws IOException {
                ...
                return CrcEnum.fromValue(value);
            }
        }
    }
    ...
    public enum StreamableEnum {
        ...
        public static StreamableEnum fromValue(Integer value) {
        ...
        public static class Adapter extends TypeAdapter<StreamableEnum> {
            ...
            public void write(final JsonWriter jsonWriter,
                              final StreamableEnum enumeration) throws IOException {
                jsonWriter.value(enumeration.getValue());
            }

            @Override
            public StreamableEnum read(final JsonReader jsonReader)
                    throws IOException {
                Integer value = jsonReader.nextInt();
                return StreamableEnum.fromValue(value);
            }
        }
    }
}
