...
public class InlineResponse20010 {
    ...
    private SeriesEpisodesResponse data;
    @SerializedName(SERIALIZED_NAME_STATUS)
    private String status;

    public InlineResponse20010 data(SeriesEpisodesResponse data) {
    ...
    public SeriesEpisodesResponse getData() {
        return data;
    }

    public void setData(SeriesEpisodesResponse data) {
        this.data = data;
    }
