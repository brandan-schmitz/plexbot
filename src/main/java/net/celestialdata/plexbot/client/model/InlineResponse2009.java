...
public class InlineResponse2009 {
    ...
    private SeriesExtendedRecord data;
    @SerializedName(SERIALIZED_NAME_STATUS)
    private String status;

    public InlineResponse2009 data(SeriesExtendedRecord data) {
    ...
    public SeriesExtendedRecord getData() {
        return data;
    }

    public void setData(SeriesExtendedRecord data) {
        this.data = data;
    }
