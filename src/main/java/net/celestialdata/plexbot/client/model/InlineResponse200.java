...
public class InlineResponse200 {
    ...
    private EpisodeBaseRecord data;
    @SerializedName(SERIALIZED_NAME_STATUS)
    private String status;

    public InlineResponse200 data(EpisodeBaseRecord data) {
    ...
    public EpisodeBaseRecord getData() {
        return data;
    }

    public void setData(EpisodeBaseRecord data) {
        this.data = data;
    }
