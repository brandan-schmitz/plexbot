...
public class InlineResponse2006 {
    ...
    private SeasonBaseRecord data;
    @SerializedName(SERIALIZED_NAME_STATUS)
    private String status;

    public InlineResponse2006 data(SeasonBaseRecord data) {
    ...
    public SeasonBaseRecord getData() {
        return data;
    }

    public void setData(SeasonBaseRecord data) {
        this.data = data;
    }
