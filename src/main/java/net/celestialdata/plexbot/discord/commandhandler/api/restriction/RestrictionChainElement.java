...
public class RestrictionChainElement {
    ...
    private static class AndCombination extends RestrictionChainElement {
        ...
        AndCombination(RestrictionChainElement left, RestrictionChainElement right) {
            this.left = left;
            this.right = right;
        }
    ...
    private static class OrCombination extends RestrictionChainElement {
         ...
         */
        @SuppressWarnings("CdiInjectionPointsInspection")
        OrCombination(RestrictionChainElement left, RestrictionChainElement right) {
            this.left = left;
            this.right = right;
        }
    ...
    private static class Negation extends RestrictionChainElement {
         ...
         */
        @SuppressWarnings("CdiInjectionPointsInspection")
        Negation(RestrictionChainElement negated) {
