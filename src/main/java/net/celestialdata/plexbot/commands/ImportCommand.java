...
public class ImportCommand implements CommandExecutor {
    ...
    public void onRequestMovieCommand(Message message, String[] args) {
        ...
        if (BotConfig.getInstance().authorizedImportUsers() == null || BotConfig.getInstance().authorizedImportUsers().contains(message.getAuthor().getId())) {
            ...
            message.getChannel().sendMessage(new EmbedBuilder()
                    ...
                    .setDescription("You are not authorized to use this command. If you believe this is a mistake please contact Brandan.")
