...
public class ResolutionManager {
     ...
     */
    public static void addUpgradableMovie(OmdbMovie movie, int oldResolution, int newResolution) {
                    ...
                    textChannel -> textChannel.sendMessage(new EmbedBuilder()
                            ...
                            .setFooter(
                                    newResolution >= 2160 ?
                                            ...
                                            "Upgradable to to " + newResolution + "p" + " from " + oldResolution+ "p"))
        ...
        Runnable checker = () -> {
            ...
            for (Movie m : movies) {
                ...
                if (m.oldResolution != 0 && torrentHandler.getTorrentQuality() > m.oldResolution) {
                    ...
                    addUpgradableMovie(Omdb.getMovieInfo(m.id), m.oldResolution, m.newResolution);
                }
            }
    ...
    private void upgradeMovie(String id) {
        Runnable downloader = () -> {
            ...
            if (!downloadHandler.deletePreviousVersions()) {
                realDebridHandler.deleteTorrent();
                BotStatusManager.getInstance().removeProcess("Upgrade " + movie.Title + " (" + movie.Year + ")");
                return;
            }
