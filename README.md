...
FolderSettings:
  ...
  # A list a characters that should not be allowed to be used within file or folder names
  # along with a character that should replace the blacklisted one if applicable.
  blacklistCharacters:
    - original: ">"
      replacement: ""
    - original: "<"
...
ImportSettings:
  ...
  # List of files to ignore in the import folders
  ignoredFiles:
    - "mount.pb"
    - ".DS_Store"
    - ".stignore"
...
PlexSettings:
  ...
  # The list of Plex servers you want the bot to automatically refresh the media libraries on when new media is added.
  # Each server needs to define the following:
  # address: The IP address of the Plex Media Server. If the bot is on the same network as the Plex server,
  #     this can be the private/local IP address, otherwise this should be the public IP address of the server
  # port: The port of the Plex Media Server. Plex defaults to 32400 unless it is manually changed
  # username: The username to your plex.tv account
  # password: The password to your plex.tv account
  plexServers:
    - address: 127.0.0.1
      port: 32400
      username: username
